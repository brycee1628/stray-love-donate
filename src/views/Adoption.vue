      ...
      <form @submit.prevent="handleSubmit" class="adoption-form">
        ...
        <section class="form-section">
          ...
          <div class="form-group">
            ...
            <textarea
              id="carePlan"
              v-model="formData.carePlan"
              rows="5"
              placeholder="請描述您對這隻寵物的照顧計畫，包括日常作息、飲食安排、醫療規劃等..."
              required
            ></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              rows="3"
              placeholder="請描述您的家庭成員（人數、年齡、是否同意領養等）"
            ></textarea>
          </div>
        </section>
        ...
        <section class="form-section">
          <div class="form-group">
            <label class="checkbox-label">
              ...
              <span>我已閱讀並同意<a href="#" @click.prevent>個資同意書</a>，同意提供個人資料用於領養申請審核 <span class="required">*</span></span>
            </label>
          </div>
        </section>
